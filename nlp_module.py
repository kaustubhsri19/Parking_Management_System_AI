        ...
        return {
            ...
            'booked_slots': {
                'patterns': [
                    ...
                    r'booked slots',
                    r'occupied slots',
                    r'show occupied parking',
                    r'what slots are booked',
                    r'list booked parking',
                    r'show reserved slots',
                    r'reserved slots'
                ],
                'query_type': 'select',
                'table': 'parking_slots',
                'sql_template': "SELECT * FROM parking_slots WHERE status='booked'",
                'description': 'Show all booked parking slots'
            },
