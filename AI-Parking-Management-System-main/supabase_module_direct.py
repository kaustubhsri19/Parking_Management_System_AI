"""
Supabase module for database operations (direct environment variables)
...
class SupabaseManager:
    def __init__(self):
        ...
        self.url = 'https://rsmqxmslaxwczzpzcopn.supabase.co'
        self.key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJzbXF4bXNsYXh3Y3p6cHpjb3BuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk4OTY3OTEsImV4cCI6MjA3NTQ3Mjc5MX0.YepGyn-qTfayEMLwpiBFV1TJaOP64SXzPb9cVg_t8q8'
