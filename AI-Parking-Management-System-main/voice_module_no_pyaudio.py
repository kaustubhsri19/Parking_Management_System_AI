"""
Voice recognition module (without PyAudio dependency)
Handles speech-to-text conversion using microphone input
This version works without PyAudio for easier installation
"""
...
class VoiceRecognizer:
    def __init__(self):
        ...
        try:
            ...
            logger.warning("Voice recognition will use file input instead")
    ...
    def get_voice_input(self, timeout: int = 5, phrase_time_limit: int = 10) -> Tuple[bool, str]:
        ...
        try:
            if self.microphone is None:
                return False, "Microphone not available. Please check your audio setup."
